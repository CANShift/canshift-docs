---
title: 'Dev setup'
description: 'Clone the per-repo CANShift projects as siblings and build them locally.'
sidebar:
  order: 1
---
...
[Add a dashboard widget](/technical/contributing/add-widget/) for that flow.
