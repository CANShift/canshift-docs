...
description: "Wire a new ECU's CAN signals into the shared schema and ship it as a preset."
sidebar:
  order: 5
---
...
The companion [ECU integration reference](/technical/reference/ecu-integration/)
...
[ECU integration reference](/technical/reference/ecu-integration/) — do not
duplicate it here.
...
`dangerLevel`, `highWarningLevel`, `highDangerLevel`, `bitMask`, `colorRamp`.
...
Follow the [CAN integration notes](/technical/reference/can-integration/) — CAN
H/L from the ECU to the CAN Pal, dash powered, USB to the workstation. The
[first-flash checklist](/user-guide/install/first-flash/) is the pre-flight if
...
- [ECU integration reference](/technical/reference/ecu-integration/) — full annotated field reference
- [CAN integration notes](/technical/reference/can-integration/) — CAN Pal wiring + bus health
- [First flash](/user-guide/install/first-flash/) — pre-flight checklist for new hardware
- [Config contract](/technical/reference/config-contract/) — overall config JSON contract
