...
description: 'Implement a new LVGL widget end-to-end across core, firmware, and tuner.'
sidebar:
  order: 6
---
...
[Release process](/technical/contributing/release-process/) for the publish
flow.
...
- [Config contract](/technical/reference/config-contract/) — JSON config shape
- [Firmware architecture overview](/technical/architecture/overview/) — package boundaries
