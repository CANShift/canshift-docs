---
title: 'Live data'
description: 'Watch every decoded signal update in real time — from the car, the simulator, or nothing at all.'
---
...
:::tip
Use Live data to validate an [ECU profile](/user-guide/configure/ecu-profiles/) before you place a single widget: apply the profile, drive the simulator or the car, and check the signals move the way you expect.
:::
