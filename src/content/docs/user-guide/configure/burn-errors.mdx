---
title: "Burn errors"
description: "When the BurnOverlay flips red — what each error means and how to recover."
sidebar:
  order: 2
---
...
The tuner queues frames over USB while CAN scan is active. Burning a config
in the middle can cause the burn to time out because the USB rxBuf is busy
draining frames. Stop CAN scan first, then burn.
</Aside>
