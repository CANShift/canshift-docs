...
Last refreshed: 2026-05-18 (see [#849](https://github.com/tburkhalterr/CANShift/issues/849)).
...
- CAN signal pipeline — `signals.json` schema-driven decode of any
  ...
  default; see [`docs/ecu-integration.md`](ecu-integration.md).
...
- Error bar — bottom overlay with swipe-up to expand, scrollable error
  list ([#642](https://github.com/tburkhalterr/CANShift/issues/642)).
- Diag drawer — ECU flag bits, status grid, firmware error log
  ([#635](https://github.com/tburkhalterr/CANShift/issues/635)).
- Physical GPIO buttons — wire any input pin to a dashboard action (page
  nav, map switch, CAN raw, cruise op)
  ([#833](https://github.com/tburkhalterr/CANShift/issues/833)).
...
- Visual dashboard editor — drag-drop canvas, widget selection, property
  ...
  ([#697](https://github.com/tburkhalterr/CANShift/issues/697)).
- Signal config route — preset picker (Generic, MaxxECU, OBD-II)
  ([#19](https://github.com/tburkhalterr/CANShift/issues/19)),
  per-signal editor, RealDash CAN XML import.
- Device config route — CAN speed, TWAI pin picker with chip-safe ∩
  board-available validation
  ([#831](https://github.com/tburkhalterr/CANShift/issues/831)).
...
- Friendly Zod error messages — IPC validation summaries surface as
  ...
  ([#832](https://github.com/tburkhalterr/CANShift/issues/832)).
...
- [#531](https://github.com/tburkhalterr/CANShift/issues/531) — ESP32
...
- Shift light LEDs over external GPIO — natural extension of the GPIO
  button work in [#833](https://github.com/tburkhalterr/CANShift/issues/833).
